...
class iDataset(data.Dataset):
    ...
    def __init__(
        ...
        self.root = os.path.expanduser(root)  # root dir of dataset
        self.transform = transform  # transform applied to each image
        self.train = train  # training set or test set
        self.validation = validation  # validation set or not
        self.seed = seed  # random seed
        self.t = -1  # task id
        self.tasks = tasks  # task list
        self.download_flag = download_flag  # download dataset or not
